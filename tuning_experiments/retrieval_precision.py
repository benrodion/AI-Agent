...
DATA = ROOT / "data"
EVAL_PATH = DATA / "problem_queries_retrieval_precision.json"
...
print(len(answer_precision))
print(len(answer_recall))
print(len(retrieval_precision))
print(len(retrieval_recall))
print(len(question_id)) # potential error source
